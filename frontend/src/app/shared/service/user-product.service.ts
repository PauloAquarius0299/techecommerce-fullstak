...
export class UserProductService {
  ...
  findAllFeaturedProducts(pageRequest: Pagination): Observable<Page<Product>> {
    ...
    return this.http.get<Page<Product>>(
      `${environment.apiUrl}/products-shop/featured`, {params}
    );
  }

  findOneByPublicId(publicId: string): Observable<Product>{
    return this.http.get<Product>(
    `${environment.apiUrl}/products-shop/find-one`, {params: {publicId}}
    );
  };
  ...
  findRelatedProduct(
    ...
    return this.http.get<Page<Product>>(
      `${environment.apiUrl}/products-shop/related`, {params}
    );
  };
  ...
  filter(
    ...
    return this.http.get<Page<Product>>(
      `${environment.apiUrl}/product-shop/filter`, {params}
    );
  }
}

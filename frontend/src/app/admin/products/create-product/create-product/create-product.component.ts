...
import { BaseProduct, CreateProductFormContent, ProductPictures, ProductSizes, sizes } from '../../../model/product.model';
...
export class CreateProductComponent {
  ...
  public productPictures = new Array<ProductPictures>();
  ...
  pictures = new FormControl<Array<ProductPictures>>([], {
    nonNullable: true,
    validators: [Validators.required],
  });
  ...
  onUploadNewPictures(target: EventTarget | null ){

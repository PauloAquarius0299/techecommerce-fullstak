...
import paulotech.backend.shared.authentification.domain.Role;
import paulotech.backend.shared.authentification.domain.Roles;
import paulotech.backend.shared.authentification.domain.Username;
...
public final class AuthenticationUser  {
    ...
    public static Optional<Username> optionalUsername() {
        return authentication().map(AuthenticationUser::readPrincipal).flatMap(Username::of);
    }
